...
const Dropdown = ({onChangeHandle, value}: DropdownProps) => {
      ...
      <SelectContent>
        ...
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <Input type="text" placeholder="New category" className="input-field mt-3" onChange={(e) => setNewCategory(e.target.value)}/>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
